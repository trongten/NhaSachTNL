...
public class GUI_SuaNV extends JFrame {
	...
	private void initialize() {
		...
		MyButton btnXoaText = new MyButton("Xóa");
		btnXoaText.setFont(new Font("Dialog", Font.BOLD, 15));
		panel_3.add(btnXoaText);
		...
		Component horizontalStrut_1 = Box.createHorizontalStrut(34);
